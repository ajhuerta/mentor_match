...
import ButtonPrimary from "./misc/ButtonPtimary"
          ...
          {listUser.map((listUsers, index) => (
            ...
            >
              <div className="flex mx-auto w-40 sm:w-auto">
                <div className="flex items-center justify-center bg-teal-100 w-12 h-12 mr-6 rounded-full">
                  <Image src={listUsers.icon} className="h-6 w-6" alt="" width={5} height={5}/>
                </div>
